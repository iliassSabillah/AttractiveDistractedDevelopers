let data = {
  about: {
    restaurant_name: 'ADD',
    restaurant_slogan: "Welcome to Good Burger, Home of the Attractive Distracted Coder's Store",
    restaurant_address: '123 Main Street, New York, NY',
    restaurant_email: 'add@gmail.com',
    restaurant_phone: '555-555-0000'
  },
  menu: {
    burgers: [{name:'Product1', price: 1.99}, {name:'Product1a', price: 2.99}, {name:'Product1b', price: 3.99}],
    drinks: [{name:'Product2', price: 1.99}, {name:'Product2a', price: 2.99}, {name:'Product2b', price: 3.99}, {name: 'Product2c', price: 3.99}],
    fries: [{name:'Product3', price: 1.99}, {name:'Product3a', price: 2.99}, {name:'Product3b', price: 3.99}],
    Desert:[{name:'Product4', price: 4.99}]
  },
